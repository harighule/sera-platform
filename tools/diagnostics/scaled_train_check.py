...
final_val_acc  = entity_ai.stats.get("cifn_synthetic_self_consistency_accuracy", 0.0)
metric_type    = entity_ai.stats.get("cifn_metric_type", "unknown")
print(
    f"\n  => Final synthetic_val_loss={final_val_loss:.4f}  "
    f"synthetic_self_consistency_acc={final_val_acc*100:.1f}%  metric_type={metric_type}"
)
